...
const ReviewResume = () => {
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      {/*  first col */}
      <form  onSubmit={onSumbitHandler} className='w-full max-w-lg pd-4 bg-white rounded-lg border border-gray-200'>
        ...
        <p className='text-xs text-gray-500 font-light mt-1'>Supports PDF reumes only</p>
      ...
      <div className='w-full max-w-lg pd-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 max-h-[600px]'>
        <div className='flex items-center gap-3'>
          ...
          <h1 className='textt-xl font-semibold'> Analysis Results </h1>
